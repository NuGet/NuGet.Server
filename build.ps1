...
Invoke-BuildStep 'Building solution' { 
        ...
        Build-Solution $Configuration $BuildNumber -MSBuildVersion "$msBuildVersion" $SolutionPath -SkipRestore:$SkipRestore -MSBuildProperties "/bl:$PSScriptRoot\output.binlog" `
    } `
    -ev +BuildErrors
